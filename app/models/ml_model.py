    ...
    async def load_model(self) -> None:
        ...
        try:
            ...
            if not settings.vectorizer_path.exists():
                raise FileNotFoundError(f"Vectorizer file not found: {settings.vectorizer_path}")
            ...
            logger.info("Vectorizer loaded successfully", vectorizer_path=str(settings.vectorizer_path))
            
            # Load metadata
            with open(settings.metadata_path, 'r') as f:
                self.metadata = json.load(f)
            logger.info("Metadata loaded successfully", metadata_path=str(settings.metadata_path))
