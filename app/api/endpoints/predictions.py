    ...
    responses={
            ...
            "content": {
                "application/json": {
                    "example": create_error_response(
                        "Invalid request format. Missing 'email_body' field.", 400
                    )
                }
            },
        },
        ...
        500: {
            ...
            "content": {
                "application/json": {
                    "example": create_error_response(
                        "Model not found. Please run training first.", 500
                    )
                }
            },
        },
...
async def predict_email(
    ...
    try:
        ...
        logger.error("Prediction failed", error=str(e), email_length=len(email_body))
...
async def get_model_info(model_manager: ModelManagerDep):
    ...
    try:
        ...
        return {"model_loaded": True, "model_info": model_info}
